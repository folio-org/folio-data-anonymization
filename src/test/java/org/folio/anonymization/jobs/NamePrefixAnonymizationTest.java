...
class NamePrefixAnonymizationTest {
  ...
  void buildSchedulesNamePrefixReplacementBatchParts() throws Exception {
    ...
    assertHasLabel(parts, ".p_title");
    assertHasLabel(parts, "$.prefix");
  }
  ...
  private static Job buildJobWithTables(ModuleTable... tables) throws Exception {
    NamePrefixAnonymization anonymization = createFactoryWithContext();
  ...
  private static NamePrefixAnonymization createFactoryWithContext() throws Exception {
