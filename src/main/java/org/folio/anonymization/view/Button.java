...
public final class Button extends StyledElement<Button> {
   ...
   */
  public Button onPress(GlobalEventHandler onPress) {
   ...
   * @return this button for chaining
   */
  public Button innerElementFocusedStyle(Style innerElementFocusedStyle) {
